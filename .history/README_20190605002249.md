...
* Go cluster
    * [by @waynewbishop](https://github.com/waynewbishop/SwiftStructures) - Go implementation of the k-modes and k-prototypes clustering algorithms.
* 
    * [by @hollance](https://github.com/hollance/swift-algorithm-club)go-galib- Genetic Algorithms library written in Go
* Language agnostic
