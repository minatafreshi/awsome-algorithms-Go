...
* Evoli
    * [by @kingreza]() - Genetic Algorithm and Particle Swarm Optimization library.
    * [by @waynewbishop](https://github.com/waynewbishop/SwiftStructures)go-cluster - Go implementation of the k-modes and k-prototypes clustering algorithms.
